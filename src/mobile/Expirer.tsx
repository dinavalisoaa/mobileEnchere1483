...
const Expirer: React.FC = () => {
  ...
  function addEnchere() {
    ...
    fo.append("key",key);
    // console
    let url = URL_IP()+"/users/" + localStorage.getItem("iduser") + "/encheresExpirer";
    console.log(url);
    fetch(url, {
      method: 'GET',
      headers: {
    ...
    <><>
      ...
      <IonPage>
        ...
        <IonContent className="Ionpadding" ref={contentRef} >
          ...
          {/* <IonSearchbar  value={key}  onIonChange={(e: any) => { setKey(e.target.value);addEnchere()}} showClearButton="always" ></IonSearchbar> */}
